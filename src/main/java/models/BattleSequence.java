...
public class BattleSequence
{
    ...
    public void Battle(Character player)
    {
        ...
        while (runBattle)
        {
            ...
            System.out.println(" [Attack] " + " [Defend] " + " [Retire] ");
            ...
            try
            {
                ...
                switch (choice)
                {
                    ...
                    case 3:
                        ...
                        System.out.println(player.getName() + " You are to weak!");
    ...
    {
        int enemyRoll = new Dice().getDice(); //Make a new dice to apply for enemy damage
